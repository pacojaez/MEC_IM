...
<!--MAIN-->
<div class="font-bold text-4xl text-center">LISTADO DE HOSPITALES</div>
    <div class="w-full ml-4 mr-4">
        <form class="w-full" action="/hospital/filtered" method="POST">
        ...
        <table class="table-auto">
            <thead>
                <tr class="bg-gray-200">
                    ...
                    <th class="w-1/6 px-4 py-2">CONTRASEÑA</th>
            ...
            <?php foreach ($hospitales as $hospital):?>
                <tr>
                    <td class="border px-4 py-2"><?=$hospital->nombre?></td>
                    <td class="border px-4 py-2"><?=$hospital->provincia?></td>
                    <td class="border px-4 py-2"><?=$hospital->email?></td>
                    <td class="border px-4 py-2"><?=$hospital->telefono?></td>
                    <td class="border px-4 py-2"><?=$hospital->contraseña?></td>
                    <td class="border px-4 py-2"><?=$hospital->updated_at?></td>
                    <td class="border px-4 py-2"><a href="/hospital/edit/<?=$hospital->id?>"><i class="fas fa-edit"></i></a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
