...
class AseguradoController{
    ...
    public function edit(int $id = 0){
        ...
        if(!$asegurado = Asegurado::getAsegurado($id)) 
            throw new Exception("No se indicó el asegurado.");

        // mostrar el formulario de edición
        include 'views/asegurado/actualizar.php';
    }
